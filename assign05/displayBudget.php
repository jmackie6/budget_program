...
$query = "SELECT * FROM budget"; //You don't need a ; like you do in SQL
$result = mysql_query($query);

//echo "<table>"; // start a table tag in the HTML

while($row = mysql_fetch_array($result)){   //Creates a loop to loop through results
echo  "food: " . $row['b_food'] . "\n" . "rent: " .$row['b_rent']. "\n" . "health insurance: " .$row['b_health_insurance'] . "\n" . "car insurance: " .$row['b_car_insurance'] . "\n". "utilities: " .$row['b_utilities'] . "\n". "other: " .$row['b_other'] . "\n";  //$row['index'] the index here is a field name
}
